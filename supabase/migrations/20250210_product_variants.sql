...
insert into public.products (sku, name, description, price, stock_quantity, category, image_url) values
  ...
  ('EMERALD-SULTAN', 'Emerald Sultan Crown', 'A symbol of dignity and refined tradition. Deep emerald-green velvet top with elegant white radial stitching and classic central button. Crisp white structured base. Perfect for Jumu''ah, Eid, and formal occasions.', 590.00, 1, 'Caps', '/collection/emerald-sultan-crown.png'),
