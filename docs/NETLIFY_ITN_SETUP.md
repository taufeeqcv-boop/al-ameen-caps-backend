...
So when `VITE_SITE_URL` is your live site (e.g. `https://www.alameencaps.com`), PayFast will POST ITNs to:

- `https://www.alameencaps.com/.netlify/functions/itn-listener`
