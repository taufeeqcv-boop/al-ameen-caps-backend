...
export const COLLECTION_PRODUCTS = [
  ...
  {
    id: "masnadi-cap",
    name: "Masnadi Cap – White & Gold Prestige",
    quantityAvailable: 4,
    stockQuantity: 4,
    originalPrice: 660,
    price: 460,
    description:
      "Masnadi Cap — White & Gold Prestige Collection\n\nA premium Masnadi crown in white and gold, selected for customers who want a statement piece that balances spiritual presence with refined elegance. Designed for Eid, nikah, and special gatherings where every detail matters.\n\nHeritage Note: Curated in partnership with Azhari Cap Global Marketing in Mumbai and finished in Cape Town, this Masnadi cap connects Mumbai craftsmanship to Cape Malay Heritage.",
    imageURL: "/images/WhatsApp Image 2026-03-12 at 2.15.37 AM (2).jpeg",
    category: "Caps",
    lastmod: "2026-03-12",
    changefreq: "daily",
  },
  {
    id: "naqshbandi-cap-white-green",
    name: "Naqshbandi Cap – White & Green (Premium)",
    quantityAvailable: 3,
    stockQuantity: 3,
    originalPrice: 950,
    price: 950,
    description:
      "Naqshbandi Cap — White & Green Premium Edition\n\nA structured Naqshbandi-style cap in white and emerald green, designed for seekers and scholars who prefer a cap profile instead of a full Taj. Ideal for dhikr gatherings, Jumu'ah, and spiritual travel.",
    imageURL: "/collection/naqshbandi-cap-white-green.png",
    category: "Caps",
    lastmod: "2026-03-12",
    changefreq: "daily",
  },
