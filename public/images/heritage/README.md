# Heritage images for the Digital Majlis

Place your heritage images here so they appear on the site.
...
These two images appear in **The Living Tree** above Tuan Guru. Add the files here with these exact names:

- **`sultan-saifuddin-tidore.png`** — Portrait of Sultan Saifuddin (Sayfoedin), King of Tidore (the historical oil painting). Place it in this folder so the Sultan Saifuddin row in the tree shows the image.
- **`sunan-gunung-jati.png`** — Portrait of Sunan Gunung Jati (Syarif Hidayatullah). Place it in this folder so the Sunan Gunung Jati row in the tree shows the image.

The tree order will be: **Sultan Saifuddin of Tidore** → **Sunan Gunung Jati (Syarif Hidayatullah)** → **Imam Abdullah Kadi Abdus Salaam (Tuan Guru)** → … (Ou Bappa, Bappa, Oemie). These two royal figures are not shown on The Wall grid, only in The Living Tree.

## Tuan Guru portrait (Living Tree + Lineage Gallery)

- **Filename:** `tuan-guru-portrait.png` (or `.jpg`)
- **Use:** The framed portrait of Tuan Guru (Imam Abdullah Bin Qadi Abdussalam)—white turban, patterned shawl, walking stick. Shown in **The Living Tree** next to his name and in the **Lineage Gallery** (first slot).
- **Location:** Place the file in this folder. The database and Heritage page reference `/images/heritage/tuan-guru-portrait.png`.
...
- **Filename:** `ebrahim-abdul-latief-talaabodien.png` (or `.jpg`)
- **Use:** Archival portrait of Die Kaapenaar Imam Ebrahiem Talaboedien and his grandson Imam Abdulatiief Talaaboedien. Shown in the **Family Portrait** section on the Heritage page. Caption: “Die Kaapenaar Imam Ebrahiem Talaboedien and his grandson Imam Abdulatiief Talaaboedien. (Archival photo)”
- **Location:** Place the file in this folder. The page references `/images/heritage/ebrahim-abdul-latief-talaabodien.png`.

## Imam Achmat Talaabodien (Bappa) — Imam Taliep (Living Tree)

- **Filename:** `imam-achmat-talaabodien-bappa.png` (or `.jpg`)
...
- **Use:** Archival photo of Cape Malay Muslims in traditional dress and fezzes. Shown in the **1800s · Evolution** timeline row (with Abu Bakr Efendi caption) and in the **Lineage Gallery** (second slot).
- **Location:** Place the file in this folder. The page references `/images/heritage/fez-cape-malay-archival.png`.
...
- **Filename:** `ships-cape-robben-island.png` (or `.jpg`)
- **Use:** Historic harbour scene (ships in Table Bay). Shown in the **1700s · Foundations** timeline row and in the **Lineage Gallery** (third slot). Illustrates the journey that brought Tuan Guru and the first exiles to the Cape and Robben Island.
- **Location:** Place the file in this folder. The Heritage page references `/images/heritage/ships-cape-robben-island.png`.

## Optional: other heritage images

You can add more images here (e.g. family trees, manuscripts, Auwal Mosque, portraits) and reference them in copy or in future Majlis submissions by URL, e.g. `/images/heritage/your-file.jpg`.
